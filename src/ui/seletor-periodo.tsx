...
export function SeletorDePeriodo() {
  ...
  return (
    <div className="inline-flex items-center rounded-full border border-wr-borda bg-wr-superficie text-[13px]">
      <Link href={hrefMes(deslocarCompetencia(atual, -1))} className="rounded-l-full px-2 py-1.5 text-wr-texto-2 hover:bg-wr-fundo" aria-label="Mês anterior">
      ...
      <Link href={hrefMes(deslocarCompetencia(atual, 1))} className="rounded-r-full px-2 py-1.5 text-wr-texto-2 hover:bg-wr-fundo" aria-label="Próximo mês">
